...
abs(number)返回数字的绝对值，如abs(-10) 返回 10
...
返回数字的平方根，数字可以为负数，返回类型为实数，如cmath.sqrt(4)返回 2+0j

float(object)

将字符串和数字转换为浮点数，如float(4)返回 4.0 ，float("-1")返回 -1.0
...
返回对数中的e值，math.e返回常量值 2.718281828459045

math.pi返回圆周率PI的值，math.pi 返回常量值 3.141592653589793
...
math.sqrt(x)返回x的平方根，不适用于负数，如math.sqrt(9) 返回 3.0
